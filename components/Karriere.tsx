...
import planungImage from '@/assets/komp/klugeKöpfe.webp';
import karriereHeroImage from '@/assets/komp/KarreiereEchtesFrontBild.webp';

// PDF Job Inserate - aus public/jobs/
const engineerPdf = '/jobs/PROMAX_Inseratvorlage_Engineer_2025-08.pdf';
const juniorEngineerFeb = '/jobs/PROMAX_Inseratvorlage_JuniorEngineer_2025-02.pdf';
const juniorEngineerMay = '/jobs/PROMAX_Inseratvorlage_JuniorEngineer_2025-05.pdf';
...
const Karriere: React.FC = () => {
    ...
    // SSR-safe: determine desktop on client only
    useEffect(() => {
    ...
    return (
        <div className="overflow-x-hidden" style={{ fontFamily: "'Inter', 'Segoe UI', 'Roboto', -apple-system, BlinkMacSystemFont, sans-serif", color: '#1e3767', minHeight: '100vh' }}>
            ...
            <section
                ...
                style={{
                    backgroundImage: `linear-gradient(rgba(30, 55, 103, 0.7), rgba(30, 55, 103, 0.7)), url(${karriereHeroImage.src})`,
