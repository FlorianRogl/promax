                    ...
                    <div className="space-y-8">
                        ...
                        <div className="border-l-4 border-orange-500 pl-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-slate-600 text-sm leading-relaxed">Weitere Informationen zum Datenschutz bei &bdquo;Youtube&ldquo; finden Sie in der Datenschutzerklärung des Anbieters unter: <a href="https://www.google.de/intl/de/policies/privacy/" className="text-orange-600 hover:text-orange-700">https://www.google.de/intl/de/policies/privacy/</a></p>
                            </div>
                        </div>
