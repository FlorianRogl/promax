...
export const CookieProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    // SSR-safe: initial state is DEFAULT_CONSENT (no localStorage read during render/SSR).
    // localStorage is only read inside the useEffect below, which runs client-side only.
    ...
    // Beim ersten Laden: aus localStorage lesen (client-side only — SSR-safe)
    useEffect(() => {
...
//   import { trackConversion } from '@/components/cookies/CookieContext';
