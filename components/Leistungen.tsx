...
import leistungHero from '@/assets/komp/LeistungenPic.webp';
import newPic from '@/assets/komp/iStock-684873524.webp';
        ...
        <div className="min-h-screen bg-white overflow-x-hidden" style={{
            ...
            <section
                ...
                style={{
                    ...
                    backgroundImage: `linear-gradient(rgba(30, 55, 103, 0.7), rgba(30, 55, 103, 0.7)), url('${leistungHero.src}')`,
