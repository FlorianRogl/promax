...
import rogl from '@/assets/komp/RoglAndreas.webp';
import christian from '@/assets/komp/Christian.webp';
import iso from '@/assets/komp/iso.webp';
import iq from '@/assets/komp/IQNet_certification_mark_2022.webp';
import CheckIcon from '@/components/CheckIcon';
import unternehmen1 from '@/assets/komp/unternehmen1.webp';
import unternehmenHero from '@/assets/komp/unternehmenPic.webp';
            ...
            <div className="min-h-screen bg-white overflow-x-hidden" style={{
                ...
                <section
                    ...
                    style={{
                        height: '115vh',
                        minHeight: '115vh',
                        backgroundImage: `linear-gradient(rgba(30, 55, 103, 0.7), rgba(30, 55, 103, 0.7)), url(${unternehmenHero.src})`,
