...
import tech1 from '@/assets/komp/tech1_gekauft.webp';
import tech3 from '@/assets/komp/3dLaser_gekauft.webp';
import tech4 from '@/assets/komp/vrBrilleEcht.webp';
import titelbild from '@/assets/komp/neuesBildTechnologie.webp';
        ...
        <div className="min-h-screen bg-white overflow-x-hidden" style={{ fontFamily: "'Inter', 'Segoe UI', 'Roboto', -apple-system, BlinkMacSystemFont, sans-serif" }}>
            ...
            <section
                ...
                style={{
                    height: '115vh',
                    minHeight: '115vh',
                    backgroundImage: `linear-gradient(rgba(30, 55, 103, 0.7), rgba(30, 55, 103, 0.7)), url('${titelbild.src}')`,
