        ...
        <div className="min-h-screen bg-white overflow-x-hidden" style={{
            ...
            >
                ...
                <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
                    <div className="opacity-0 translate-y-8 animate-fade-in-up">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-white mb-4 sm:mb-6 leading-tight px-2 break-words">
                            {t('services.heroTitle')}
                        </h1>
                        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium text-[#d97539] leading-relaxed px-2 sm:px-4 break-words">
            ...
            <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
                    ...
                    {/* Ingenieurplanung */}
                    <div id="ingenieurplanung" className="mb-16 sm:mb-20 md:mb-24 pt-16 sm:pt-20 -mt-16 sm:-mt-20">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
                            {/* Content */}
                            <div className="order-2 lg:order-1">
                                {/* Header - Mobile: vertical, Desktop: horizontal */}
                                <div className="flex flex-col items-center text-center lg:flex-row lg:items-start lg:text-left mb-6 sm:mb-8">
                                    <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-[#1e3767] rounded-lg sm:rounded-xl flex items-center justify-center mb-4 lg:mb-0 lg:mr-4 lg:mr-6 flex-shrink-0">
                                        <svg className="w-6 h-6 sm:w-7 sm:h-7 md:w-9 md:h-9 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
                                    ...
                                    <div className="flex-1 min-w-0 w-full">
                                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light text-[#1e3767] mb-2 break-words hyphens-auto px-2 lg:px-0">
                                            {t('services.engineeringTitle')}
                                        </h2>
                                        <div className="w-12 sm:w-16 h-1 bg-[#d97539] mx-auto lg:mx-0"></div>
                                    </div>
                                </div>

                                {/* Anlagenkonzeption und Design */}
                                <div className="mb-6 sm:mb-8">
                                    <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#1e3767] mb-3 sm:mb-4 break-words hyphens-auto">
                    ...
                    <div id="operative-projektstuetzung" className="pt-16 sm:pt-20 -mt-16 sm:-mt-20">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
                            {/* Image - Smaller on mobile */}
